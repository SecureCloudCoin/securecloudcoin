...
cp $TRAVIS_BUILD_DIR/src/qt/securecloudcoin-qt $OUTDIR/bin/ || cp $TRAVIS_BUILD_DIR/src/qt/securecloudcoin-qt.exe $OUTDIR/bin/ || echo "no QT Wallet"
cp $TRAVIS_BUILD_DIR/src/securecloudcoind $OUTDIR/bin/ || cp $TRAVIS_BUILD_DIR/src/securecloudcoind.exe $OUTDIR/bin/
cp $TRAVIS_BUILD_DIR/src/securecloudcoin-cli $OUTDIR/bin/ || cp $TRAVIS_BUILD_DIR/src/securecloudcoin-cli.exe $OUTDIR/bin/
