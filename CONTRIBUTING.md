Contributing to SecureCloudCoin Core
============================

The SecureCloudCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the SecureCloudCoin Core project, and is not to be
confused with overall SecureCloudCoin Network Protocol consensus changes.

Whether a pull request is merged into SecureCloudCoin Core rests with the project merge
...
Patches that change SecureCloudCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the SecureCloudCoin consensus, it must have been
...
The project leader is the release manager for each SecureCloudCoin Core release.
