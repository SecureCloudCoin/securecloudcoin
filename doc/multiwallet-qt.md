...
In order to support loading of multiple wallets in securecloudcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is securecloudcoin.cpp.
...
Changes to securecloudcoin.cpp
----------------------
securecloudcoin.cpp is the entry point into securecloudcoin-qt, and as such, will require some minor modifications to provide hooks for
