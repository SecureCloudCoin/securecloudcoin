                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Rup from zSc2"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zSc2"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zSc2));
