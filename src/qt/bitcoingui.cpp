                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("SecureCloudCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SecureCloudCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and securecloudcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSC2"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About SecureCloudCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about SecureCloudCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SecureCloudCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SecureCloudCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SecureCloudCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a SecureCloudCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SecureCloudCoin Core help message to get a list with possible SecureCloudCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("SecureCloudCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SecureCloudCoin network", "", count));
}
...
{
    QString strTitle = tr("SecureCloudCoin Core"); // default title
    ...
    // Append title to "SecureCloudCoin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
