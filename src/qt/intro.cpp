...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("SecureCloudCoin Core"),
     ...
     * override -datadir in the securecloudcoin.conf file in the default data directory
     * (to be consistent with securecloudcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
