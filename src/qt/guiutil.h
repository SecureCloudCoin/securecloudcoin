...
/** Utility functions used by the SecureCloudCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render SecureCloudCoin addresses in monospace font
...
// Parse "securecloudcoin:" URI into recipient object, return true on successful parsing
