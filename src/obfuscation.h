...
{
public:
    /// Is the inputs associated with this public key? (and there is 12345 SC2 - checking if valid masternode)
...
public:
    ...
    /// Get the denominations for a specific amount of securecloudcoin.
