...
//! SecureCloudCoin RPC error codes
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! SecureCloudCoin is not connected
    ...
    RPC_WALLET_PASSRUPASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
