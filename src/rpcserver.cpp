...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop SecureCloudCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "SecureCloudCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SecureCloudCoin features */
        {"securecloudcoin", "masternode", &masternode, true, true, false},
        {"securecloudcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"securecloudcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"securecloudcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"securecloudcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"securecloudcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"securecloudcoin", "startmasternode", &startmasternode, true, true, false},
        {"securecloudcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"securecloudcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"securecloudcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"securecloudcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"securecloudcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"securecloudcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"securecloudcoin", "mnbudget", &mnbudget, true, true, false},
        {"securecloudcoin", "preparebudget", &preparebudget, true, true, false},
        {"securecloudcoin", "submitbudget", &submitbudget, true, true, false},
        {"securecloudcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"securecloudcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"securecloudcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"securecloudcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"securecloudcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"securecloudcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"securecloudcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"securecloudcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"securecloudcoin", "mnsync", &mnsync, true, true, false},
        {"securecloudcoin", "spork", &spork, true, true, false},
        {"securecloudcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"securecloudcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use securecloudcoind, or the -server option to securecloudcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> securecloudcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7654/\n";
}
