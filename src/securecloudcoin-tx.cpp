...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("SecureCloudCoin Core securecloudcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  securecloudcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded securecloudcoin transaction") + "\n" +
                               "  securecloudcoin-tx [options] -create [commands]   " + _("Create hex-encoded securecloudcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded securecloudcoin transaction
